declare module 'dom-anchor-text-quote' {
  ...
  export function toRange(root: Node, selector: TextQuoteSelector, options?: ToRangeOptions): Range | null;
  export function toTextPosition(root: Node, selector: TextQuoteSelector, options?: ToRangeOptions): TextPositionSelector | null;
}
